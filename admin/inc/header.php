...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Proto International Group</title>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img style="width: auto; height: 30px;" src="../img/smalllogo.png" alt="Proto International Group"> </span>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/logout.php" title="Sign Out" data-action="userLogout" data-logout-msg="Desea cerrar la sesión iniciada?"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
