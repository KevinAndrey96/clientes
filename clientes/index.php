		...
		<div class="container-login100" style="background-image:url(assets/img/homelogin.jpg);padding-top:10%;">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					...
					<center><img src="../img/smalllogo.png" alt="IMG" class="img img-responsive" style="padding-top: 50px;"></center>
				</div>
				...
				<form class="login100-form validate-form" action="Controller/login.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Email incorrecto">
						<input class="input100" type="text" name="User" placeholder="Correo electrónico">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="olvido-contrasena.php">
							Contraseña?
						</a>
					</div>
