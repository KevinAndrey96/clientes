    ...
    <div>
        <div class="row header">
            <div class="col-md-2 col-md-offset-8 col-sm-12 col-xs-12">
                <a href="cambio-de-clave.php" style="color:#ffffff;"><p class="text-center">CAMBIAR CLAVE</p></a>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12">
                <a href="logout.php" style="color:#ffffff;"><p class="text-center"><i class="glyphicon glyphicon-star"></i>CERRAR SESIÓN </p></a>
            </div>
        </div>
    </div>
